...
public class WebScreenshotUtils {
    ...
    public String saveWebPageScreenshot(String webUrl) {
        ...
        try {
            ...
            // 原始图片的保存路径
            String imageFilePath = rootPath + File.separator + RandomUtil.randomNumbers(5) + IMAGE_SUFFIX;
            // 访问网页
            ...
            // 保存图片
            saveImage(imageBytes, imageFilePath);
            log.info("原始截图图片保存成功: {}", imageFilePath);
            // 压缩图片
            final String COMPRESSED_IMAGE_SUFFIX = "compressed.jpg";
